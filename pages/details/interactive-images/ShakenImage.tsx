...
const ShakenImage: React.FC = ()=> {
    ...
    return (
          <div className="relative w-full h-full">
            <img
              src="/details_images/astigmatism.jpg"
              alt="astigmatism-details"
              className="object-cover w-full h-full"
            />
             <div 
             ref={containerRef}
             className="absolute inset-y-0 right-0 backdrop-blur-sm bg-white/[0] w-3/4 border-l-2 border-blue-950"
