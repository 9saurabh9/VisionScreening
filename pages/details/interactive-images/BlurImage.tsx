...
const BlurImage: React.FC = ()=> {
    ...
    return (
          <div className="relative w-full h-full">
            <img
              src="/details_images/visual-acuity.jpg"
              alt="visual-acuity-details"
              className="object-cover w-full h-full"
            />
             <div 
             ref={containerRef}
             className="absolute inset-y-0 right-0 backdrop-blur-[2px] bg-white/[0] w-3/4 border-l-2 border-blue-950"
