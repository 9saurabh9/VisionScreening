...
const WhitenImage: React.FC = ()=> {
    ...
    return (
          <div className="relative w-full h-full">
            <img
              src="/details_images/contrast-vision.jpg"
              alt="contrast-vision-details"
              className="object-cover w-full h-full"
            />
             <div 
             ref={containerRef}
             className="absolute inset-y-0 right-0 backdrop-brightness-200 bg-white/30 w-3/4 border-l-2 border-blue-950"
             style={{ width: `${width}px`, maxWidth: '100%' }}
             onMouseDown={handleMouseDown}
             onTouchStart={handleTouchStart}>
                <div className="bg-black rounded-full p-2 w-14 h-14 absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 flex justify-between items-center">
