...
const VisualAcuityResult: React.FC = ()=> {
    const [message, setMessage] = useState<string>("Your visual acuity in <strong>both eyes</strong> seems to be excellent");
...
export default VisualAcuityResult;